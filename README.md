...
Iqbal, A., Ogundimu, E.O., and Rubio, F.J. (2026+). Bayesian variable selection in sample selection models using spike-and-slab priors. [*Computational Statistics*](https://doi.org/10.1007/s00180-026-01745-3), in press. [Preprint](https://doi.org/10.48550/arXiv.2312.03538)
